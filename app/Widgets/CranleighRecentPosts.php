...
class CranleighRecentPosts extends WP_Widget {
	function __construct() {
		$widget_ops = array(
			'classname' => 'recentposts',
			'description' => 'Cranleigh Recent Posts'
		);
		parent::__construct('cranleigh-recent-posts', 'Cranleigh Recent Posts Widget', $widget_ops);
	}
